          ...
          <div className="swiper catecards-slider">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">Narrative Filmmaker</h2>
            ...
            <div className="swiper-slide catecards-slide">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">Documentary Filmmaker</h2>
                    <p className="card-body">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Inventore, praesentium.
                    </p>
            ...
            <div className="swiper-slide catecards-slide">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">Commercial/Advertising Editor</h2>
                    <p className="card-body">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Inventore, praesentium.
                    </p>
            ...
            <div className="swiper-slide catecards-slide">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">Music Video Editor</h2>
                    <p className="card-body">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Inventore, praesentium.
                    </p>
            ...
            <div className="swiper-slide catecards-slide">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">VFX Editor</h2>
                    <p className="card-body">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Inventore, praesentium.
                    </p>
            ...
            <div className="swiper-slide catecards-slide">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">Experimental Filmmaker</h2>
                    <p className="card-body">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Inventore, praesentium.
                    </p>
            ...
            <div className="swiper-slide catecards-slide">
              ...
              >
                ...
                >
                  <div className="card-content">
                    <h2 className="card-title">Social Media Content Creator</h2>
                    <p className="card-body">
                      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                      Inventore, praesentium.
                    </p>
